...
def hex2str( h):
    ...
    for i in range(len(h)):
        while h[i] > 0:
            ...
            h[i] = h[i] // 256
    return s
def zuc_encrypt(plain_text, key_stream):
    cipher_text = []
    for i in range(len(plain_text)):
        cipher_text.append(plain_text[i] ^ key_stream[i])
    return cipher_text

def print_S():#打印s0-s15
    for i in range(16):
        if i==8:
            print()
...
if __name__ == '__main__':
    ...
    plain_text=[str2hex(data)]
    a=zuc_encrypt(plain_text,Key_result)
    print('cipher_text= ',a)
    print('>>解密')
    b=zuc_encrypt(a,Key_result)
